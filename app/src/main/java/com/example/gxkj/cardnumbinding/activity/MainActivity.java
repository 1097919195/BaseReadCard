...
import com.example.gxkj.cardnumbinding.fragment.AssignStoreFragment;
...
public class MainActivity extends BaseActivity implements ILotusCallBack{
    ...
    AssignStoreFragment assignStoreFragment;
...
//        initRxBus2WithSamplePhoto();
    ...
    private void initFragment(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            assignStoreFragment = (AssignStoreFragment) getSupportFragmentManager().findFragmentByTag("assignStoreFragment");
            ...
            assignStoreFragment = new AssignStoreFragment();
            ...
            transaction.add(R.id.fl_body, assignStoreFragment, "assignStoreFragment");
        }
        transaction.commit();
        SwitchTo(currentTabPosition);
    }

    @OnClick({R.id.bindingWithSample,R.id.bindingWithStaff,R.id.bindingWithGoods,R.id.assignStore})
    ...
    private void SwitchTo(int position) {
        ...
        switch (position) {
            case 0:
                ...
                transaction.hide(assignStoreFragment);
                ...
                assignStore.setTextColor(getResources().getColor(R.color.white));
                break;
            case 1:
            ...
            case 3:
                ...
                transaction.hide(staffBindingFragment);
                transaction.hide(goodsBindingFragment);
                transaction.show(assignStoreFragment);
                transaction.commitAllowingStateLoss();
                bindingWithSample.setTextColor(getResources().getColor(R.color.white));
                bindingWithStaff.setTextColor(getResources().getColor(R.color.white));
                bindingWithGoods.setTextColor(getResources().getColor(R.color.white));
                assignStore.setTextColor(getResources().getColor(R.color.red));
                break;
            default:
                break;
        }
